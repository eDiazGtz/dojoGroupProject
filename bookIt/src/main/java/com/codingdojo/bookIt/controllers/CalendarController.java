...
import com.codingdojo.bookIt.repositories.EventRepository;
...
public class CalendarController {
	...
	//TO-DO: Needs a Service -- fix later
    @Autowired
    EventRepository er;
    ...
    Event moveEvent(@RequestBody EventMoveParams params) {
    	...
    	//This seems to be a Service Method  --- needs to be rewritten.
    ...
    //What are these Methods? Are these supposed to be in the Service? Explore Later
